...
# Start Gunicorn as appuser (no Nginx - Peach server provides its own)
...
# Gunicorn is running - wait for it in the foreground
echo "Gunicorn started successfully on port 5000"
wait $GUNICORN_PID
